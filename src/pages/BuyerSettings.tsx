...
import { ArrowLeft, Building2, MapPin, Phone, Mail, Globe, Languages, Shield, Bell, CreditCard, HelpCircle, LogOut, Check, AlertCircle, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <header className="bg-card border-b border-border px-4 py-4 sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <Link to="/buyer/profile" className="w-10 h-10 rounded-xl bg-muted flex items-center justify-center">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Get notified when listings you've inquired about are updated</p>
                </div>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Bell className="w-5 h-5 text-muted-foreground" />
                <div>
                  <p className="font-medium text-foreground">Inquiry Responses</p>
                  <p className="text-sm text-muted-foreground">Receive notifications when sellers respond to your inquiries</p>
                </div>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Get notified when prices drop for items you're interested in</p>
                </div>
              </div>
              <Switch
