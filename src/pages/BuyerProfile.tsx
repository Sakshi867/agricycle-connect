...
const BuyerProfile = () => {
  ...
  const [tempData, setTempData] = useState(buyerData);
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      if (currentUser?.uid) {
        ...
        setBuyerData(prev => ({ ...prev, photoURL }));
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold">{isEditing ? (
                  <input
                    ...
                    className="bg-transparent border-b border-secondary-foreground/30 focus:outline-none focus:border-secondary-foreground text-secondary-foreground"
